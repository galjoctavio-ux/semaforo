# Semáforo de TESIVIL · Beta pública Android 0.3.4

App Android disponible al público, con descarga gratuita y código consultable en este repositorio. Requiere Android 14 o posterior. Lee tarjetas compatibles en español de UberX, UberXL, Priority y Comfort, con Exclusivo/Aceptar, en fondos claros u oscuros. Evalúa costos, metas, zonas y pasajero. La aceptación/rechazo permanece a cargo del conductor. Es un proyecto independiente, sin afiliación ni respaldo de Uber.

**Página:** https://semaforo.uber.tesivil.com/ · **Código:** https://github.com/galjoctavio-ux/semaforo · **Descarga alternativa:** [Release v0.3.4](https://github.com/galjoctavio-ux/semaforo/releases/tag/v0.3.4).
