# Semáforo de TESIVIL · Beta pública Android 0.3.3

App Android disponible al público, con descarga gratuita y código consultable en este repositorio. Requiere Android 14 o posterior. Lee ofertas visibles de UberX, UberXL y Priority en español, incluyendo tarjetas Exclusivo/Aceptar compatibles, y evalúa costos, metas, zonas y pasajero. La aceptación/rechazo permanece a cargo del conductor. Es un proyecto independiente, sin afiliación ni respaldo de Uber.

**Página:** https://semaforo.uber.tesivil.com/ · **Código:** https://github.com/galjoctavio-ux/semaforo · **Descarga alternativa:** [Release v0.3.3](https://github.com/galjoctavio-ux/semaforo/releases/tag/v0.3.3).
...
Los formatos con horas, múltiples destinos y categorías distintas de UberX/UberXL/Priority siguen pendientes. La app no lee ofertas ausentes/ocultas/protegidas ni evade cierres forzados/restricciones del fabricante. El usuario reportó 0.3.2 funcionando, con pausas durante el efecto azul de Exclusivo. La mejora de 0.3.3 requiere comprobar esa animación en su teléfono. La verificación local está en verification/release-0.3.3.json.
...
Las clases de pruebas Android se incluyen, pero las fotos privadas usadas en ciertas regresiones no se redistribuyen. Para ejecutar esos casos aporta tus propias muestras a las rutas indicadas en las clases. Las 89 pruebas unitarias no dependen de esas fotos. La verificación de 48 pruebas Android de la release se hizo localmente con esas muestras; no se afirma que se ejecute completa sin ellas.
