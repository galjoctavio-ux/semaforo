# Semáforo de TESIVIL · Beta pública Android 0.5.4

App Android disponible al público, con descarga gratuita y código consultable en este repositorio. Requiere Android 14 o posterior. Lee tarjetas compatibles en español de UberX, UberXL, Priority y Comfort, con Exclusivo, «Aceptar», «Viaje disponible» o «Me interesa», en fondos claros u oscuros, y «Reservar UberX» con advertencia de horario y espera previa. Evalúa costos, metas, zonas y pasajero. La aceptación/rechazo permanece a cargo del conductor. Es un proyecto independiente, sin afiliación ni respaldo de Uber.

**Versión actual: 0.5.4.** Reconoce «Me interesa» como botón final de una oferta; conserva «Aceptar» y «Viaje disponible». Mantiene el banner de una línea, los formatos claros y oscuros, Priority, UberXL, Exclusivo y Reservar UberX. También conserva los perfiles con uso compartido y el Plan del mes. [Botón Me interesa](VERSION_0.5.4.md) · [Banner mínimo](VERSION_0.5.3.md) · [Recorrido y supuestos](ONBOARDING.md) · [Corrección del lector](VERSION_0.5.2.md).

**Página:** https://semaforo.uber.tesivil.com/ · **Código:** https://github.com/galjoctavio-ux/semaforo · **Descarga:** [Release v0.5.4](https://github.com/galjoctavio-ux/semaforo/releases/tag/v0.5.4).
