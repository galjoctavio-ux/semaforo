...
final class Overlay {
    ...
    Overlay(Context context, Runnable stop) {
        ...
        title = Ui.text(context, "SEMÁFORO · 0.3.4", 11, true); title.setTextColor(Color.rgb(122, 221, 238));
    ...
    void update(String status, OfferParser.Offer offer, long ms) {
        ...
        title.setText(offer==null?"SEMÁFORO · 0.3.4":"TIPO: "+offer.typeLabel().toUpperCase(java.util.Locale.ROOT));
