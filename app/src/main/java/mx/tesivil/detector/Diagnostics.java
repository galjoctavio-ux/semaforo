...
final class Diagnostics {
    ...
    static JSONObject offerJson(OfferParser.Offer o)throws JSONException{
        ...
        j.put("reader_version","0.3.5");j.put("service_type",o.serviceType.name());j.put("service_label",o.typeLabel());j.put("exclusive",o.exclusive);
    ...
    static String export(Context c)throws JSONException{
        JSONObject j=new JSONObject();j.put("schema",5);j.put("app_version","0.3.5");j.put("model",Build.MANUFACTURER+" "+Build.MODEL);
