...
- Release pública: https://github.com/galjoctavio-ux/semaforo/releases/tag/v0.3.3
- APK directa: https://semaforo.uber.tesivil.com/descargas/Detector-ofertas-0.3.3.apk
...
El APK Android no se recompiló para esta publicación. Las notas de versiones anteriores documentan el desarrollo y pruebas; la versión pública distribuida aquí es 0.3.3. Las claves de firma, capturas privadas y diagnósticos de sesiones se conservan fuera de Git.
